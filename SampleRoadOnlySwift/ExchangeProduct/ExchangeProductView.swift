...
import Foundation
class ExchangeProductView: UIView {
...
//        dismissPickerView()
    ...
    func addSubviewFunc(){
        ...
        [titBackground,dateLbl,deliveryNumLbl,productInfoBackground,retunrReasonLbl,reasonDetailTit,reasonDetailContent,nextBtn].forEach {
    ...
    func setLayout(){
        ...
        nextBtn.snp.makeConstraints {
            $0.left.equalToSuperview().offset(margin2)
            $0.right.equalToSuperview().offset(-margin2)
            $0.top.equalTo(reasonDetailContent.snp.bottom).offset(margin2 * 2)
            $0.height.equalTo(50)
...
extension ExchangeProductView:  UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource{
