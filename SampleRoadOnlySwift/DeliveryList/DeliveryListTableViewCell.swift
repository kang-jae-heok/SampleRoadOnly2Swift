...
class DeliveryListTableViewCell: UITableViewCell {
    ...
    func addSubviewFunc(){
        ...
        [readyLbl,readyPoint,readyBar,startLbl,startBar,startPoint,shippingBar,shippingLbl,shippingPoint,arrivalLbl,arrivalPoint].forEach{
    ...
    func setLayout(){
        ...
        startPoint.snp.makeConstraints{
            $0.left.equalTo(readyBar.snp.right).offset(2)
            $0.bottom.equalToSuperview()
            $0.size.equalTo(pointSize)
        }
